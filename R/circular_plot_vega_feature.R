            ...
            transform = list(
                ...
                .vega_formula("angle_1",
                              paste0("(",
                                     ...
                                     " + feature_view_1_rotation",
                                     " + feature_view_1_degrees * (datum.position_fraction - 0.5)) % 360")),
                .vega_formula("angle_2",
                              paste0("(",
                                     .vega_get_region_angle(),
                                     " + feature_view_2_rotation",
                                     " + feature_view_2_degrees * (datum.position_fraction - 0.5)) % 360")),
    ...
    list(
        ...
        encode = list(
            ...
            update = list(
                ...
                y = list(signal = paste("center_y - datum.features_linked_to_line_count *",
                                      "feature_link_tooltip_text_size / 2")),
