.gwes_plot_panel <- function() {
    shiny::tabPanel("GWES Manhattan",
        ...
        shiny::conditionalPanel(
            ...
            .div_inline_block(6, shiny::sliderInput("gwes_size_direct", "Direct point size:", min = 0.05, max = 10, value = 1, step = 0.05)),
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("gwes_size_indirect", "Indirect point size:", min = 0.05, max = 10, value = 0.5, step = 0.05)),
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("gwes_selection_size", "Selection size:", min = 0.05, max = 30, value = 5, step = 0.1)),
        ),
        shiny::conditionalPanel(
            condition = "input.show_gwes_plot_text_size",
            .div_inline_block(6, shiny::sliderInput("gwes_axis_size", "Axis text size:", min = 6, max = 50, value = 14, step = 1)),
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("gwes_title_size", "Axis title size:", min = 6, max = 50, value = 14, step = 1)),
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("gwes_legend_size", "Legend size:", min = 6, max = 50, value = 14, step = 1))
        ),
        shiny::conditionalPanel(
