.tree_plot_panel <- function() {
    shiny::tabPanel("Tree-MSA",
        ...
        shiny::conditionalPanel(
            ...
            .div_inline_block(6, shiny::sliderInput("tree_plot_width", "Figure width (cm):", min = 10, max = 50, value = 20)),
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("tree_plot_height", "Figure height (cm):", min = 10, max = 50, value = 20))
        ),
        shiny::conditionalPanel(
            ...
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("tree_label_fs", "Column label font size:", min = 2, max = 30, value = 5)),
            .div_inline_br_block(0.5),
        ...
        shiny::conditionalPanel(
            ...
            .div_inline_block(6, shiny::sliderInput("tree_legend_fs", "Legend font size:", min = 8, max = 30, value = 14)),
            .div_inline_br_block(0.5),
            .div_inline_block(6, shiny::sliderInput("tree_legend_size", "Legend size:", min = 0.5, max = 3, value = 1.4))
        ),
        shiny::br(), shiny::br(),
