...
.main_parameter_signals <- function() {
    list(
        ...
        list(name = "radius_offset_adjustment", value = .get_cp_radius_offset_adjustment()),
        list(name = "radius_offset_1", value = .get_cp_radius_offset()),
        list(name = "radius_offset_2", update = "radius_offset_1 + radius_offset_adjustment"),
        list(name = "radius_genes_1", update = "radius - radius_offset_1"),
        list(name = "radius_genes_2", update = "radius - radius_offset_2"),
        list(name = "gene_arc_angle_adjustment", value = 0),
