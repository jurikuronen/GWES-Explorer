.data_sidebar_layout <- function() {
    shiny::sidebarLayout(
        shiny::sidebarPanel(
            ...
            shiny::actionButton(inputId = "read_example_data_button", label = "Load example data (Maela)"),
            .div_inline_br_block(3),
        ...
        shiny::mainPanel(
            ...
            shiny::code("type", shiny::HTML("&nbsp;"),
                        ...
                        "attributes"),
            shiny::br(), shiny::br(),
            shiny::p("defined. GWES-Explorer primarily looks for \"gene\" in the ",
                     shiny::code("type"), "field and secondarily \"CDS\". Further, the ",
